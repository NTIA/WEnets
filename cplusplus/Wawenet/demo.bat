@echo off
Rem This file demos WAWEnet functionality and provides some verification that the code has been compiled correctly.
:: Assumes Wawenet.exe is in this directory, and that sample speech is located in ..\..\speech

echo *****************************************************************
:: One .wav file
Wawenet.exe ..\..\speech\T000439_Q231_D401.wav
...
Wawenet.exe list.txt

:: list of 10 .wav files, results to screen and myText.txt
Wawenet.exe list.txt -o myText.txt
...
Wawenet.exe ..\..\speech\long.wav -m 2 -l 0 -s 12000 -c 1
echo result should be: 
...
Wawenet.exe ..\..\speech\long_silence.wav -m 2 -l 0 -s 12000
:: result should be:
...
Wawenet.exe ..\..\speech\TwoChannel_53_93.wav -c 1
echo result should be: 
...
Wawenet.exe ..\..\speech\TwoChannel_53_93.wav -c 2
echo result should be: 
...
Wawenet.exe ..\..\speech\T000863_Q316_D401_8.wav
echo result should be: 
...
Wawenet.exe ..\..\speech\T000863_Q316_D401.wav
echo result should be: 
echo ..\..\speech\T000863_Q316_D401.wav:  1 16000 3.000000 -25.981779 0.480940 1 48000 1 [ 3.675040 ] 3.675040
echo.
...
Wawenet.exe ..\..\speech\T000863_Q316_D401_24.wav
echo result should be: 
...
Wawenet.exe ..\..\speech\T000863_Q316_D401_32.wav
echo result should be: 
...
Wawenet.exe ..\..\speech\T000863_Q316_D401_48.wav
echo result should be: 
...
echo *****************************************************************
:: One .wav file, mode 1
Wawenet.exe ..\..\speech\T000863_Q316_D401.wav -m 1
echo result should be: 
echo ..\..\speech\T000863_Q316_D401.wav:  1 16000 3.000000 -25.981779 0.480940 1 48000 1 [ 3.675040 ] 3.675040
echo.
...
echo *****************************************************************
:: One .wav file, mode 2
Wawenet.exe ..\..\speech\T000863_Q316_D401.wav -m 2
echo result should be: 
...
echo *****************************************************************
:: One .wav file, mode 3
Wawenet.exe ..\..\speech\T000863_Q316_D401.wav -m 3
echo result should be: 
...
echo *****************************************************************
:: One .wav file, mode 4
Wawenet.exe ..\..\speech\T000863_Q316_D401.wav -m 4
echo result should be: 
