...
class NormalizeTarget:
    ...
    def __init__(self, target_column_ind: int, target_key: str = "pred_metric"):
        """
    ...
    def __call__(self, sample: dict) -> dict:
        ...
        sample : dict
            ...
            a measurement associated with a specific speech sample in the row of
        ...
        """
        sample[self.target_key][self.target_column_ind] = self.normalizer(
            sample[self.target_key][self.target_column_ind],
            self.target_minimum,
            self.target_maximum,
        )
        return sample
...
class NormalizeGenericTarget(NormalizeTarget):
    ...
    def __init__(self, target_column_ind=0, target_key: str = "pred_metric"):
        super().__init__(target_column_ind, target_key=target_key)
...
def get_normalizer_class(
    target: str, target_column_ind: int = 0, target_key: str = "pred_metric"
